  ...
  return (
    <div id='contact' className='w-full lg:h-screen'>
      <div className='max-w-[1240px] m-auto px-2 py-16 w-full '>
        <p className='text-xl tracking-widest uppercase text-[#646464] '> CONTACT </p>
        ...
        {/* left */}
         <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-300 rounded-xl p-4 '>
            <div className='lg:p-4 h-full'>
                ...
                <div>
                <h2 className='py-2'>Gloriane Kingolo</h2>
                <p className=' text-[#646464] font-bold'>Full Stack Developer</p>
                <p className='py-4'>
              ...
              <div>
                <p className='uppercase pt-8 text-[#646464]'>Connect With Me</p>
